...
import { faFacebook, faInstagram, faGithub, faTwitterSquare } from '@fortawesome/free-brands-svg-icons';
           ...
           <h3 className='teamHdr'> <span><FontAwesomeIcon icon={faUsers} /> M</span>y Team Members</h3><hr />
            <div className="teamCont">
                    ...
                    {/* <div className="member">
                        ...
                        <h3>Orpannita <FontAwesomeIcon icon={faHeart} /></h3>
                        <h4>Wordprees Developer</h4>
                        <div className="teamIco"> 
